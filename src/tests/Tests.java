...
public class Tests {
    public static void main(String[] args) throws Exception {
        ...
        slime.execBlock(c);
        System.out.println("Test 3: " + ((double) space.get("b") == 2100.0D));

        final String d = "a = 123456 is 123456";
        slime.execBlock(d);
        System.out.println("Test 4: " + ((boolean) space.get("a")));

        final String e = "a = -123456 is 123456";
        slime.execBlock(e);
        System.out.println("Test 5: " + !(boolean) space.get("a"));

        final String f = "a = ((1 + (7 + 1)) * 171) + 191";
        slime.execBlock(f);
        System.out.println("Test 6: " + ((double) space.get("a") == 1730.0D));
    }
}
